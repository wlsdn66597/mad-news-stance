...
#                         reading the agents' analyses (JUDGE_INPUT)
#
...
# debate_trace hands the judge the agents' own analyses; article_only gives it
# the article alone. With shared prompts the three analyses were near-copies and
# article_only won, but persona analyses are three different readings, which is
