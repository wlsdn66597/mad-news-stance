...
def conditions(args, seed):
    ...
    rows = {
        ...
        "persona 4R self-refine (full)": from_phase2(
            f"{base}_r4_personas_selfrefine-full.json", "debate"),
        ...
        "persona 4R reasoned-exchange NONE": from_phase2(
            f"{base}_r4_personas_reasoned_exchange_none.json", "debate"),
