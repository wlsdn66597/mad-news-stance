...
class AgentPersonaTest(unittest.TestCase):
    ...
    def test_one_agent_role_removals_keep_only_the_remaining_role(self):
        no_sourcing = stance_personas(1, mix="wording")
        no_wording = stance_personas(1, mix="sourcing")

        self.assertEqual(len(no_sourcing), 1)
        self.assertEqual(len(no_wording), 1)
